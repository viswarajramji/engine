...
import com.engine.sale.constants.ApplicationConstants;
...
public class SalesTransactionService {
    ...
    public SalesTransactionService() {
        try (InputStream schemaStream = getClass().getClassLoader().getResourceAsStream("schema/sales_transaction_schema.json")) {
